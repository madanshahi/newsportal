<?php
function bichitra_block($categoryid,$limit=null,$offset=null,$limittext = null)
{
    wp_reset_query();
...
<div class="soft__wrap bichitra_spot">
...
function bichitra_sm($categoryid,$limit=null,$offset=null,$limittext = null)
{
    wp_reset_query();
    $limittext = !empty($limittext) ? $limittext : 90;
    $args = array(
...
function bichitra_smside($categoryid,$limit=null,$offset=null,$limittext = null)
{
    wp_reset_query();
    $limittext = !empty($limittext) ? $limittext : 90;
    $args = array(
