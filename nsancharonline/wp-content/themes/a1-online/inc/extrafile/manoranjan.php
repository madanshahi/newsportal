<?php
function mano_block($categoryid,$limit=null,$offset=null,$limittext = null)
{
    wp_reset_query();
    ...
    <div class="thumb_over_layer" style="height: 574px;">
<div class="shadow__layer"></div>
...
function mano_sm($categoryid,$limit=null,$offset=null,$limittext = null)
{
    wp_reset_query();
    $limittext = !empty($limittext) ? $limittext : 90;
    $args = array(
...
function mano_smside($categoryid,$limit=null,$offset=null,$limittext = null)
{
    wp_reset_query();
    $limittext = !empty($limittext) ? $limittext : 90;
    $args = array(
